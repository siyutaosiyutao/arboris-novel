...
.stat-card {
  @apply bg-white border border-slate-200 rounded-lg p-6 flex items-start gap-4;
}
...
.stat-value {
  @apply text-2xl font-bold text-slate-900 mt-1;
}
...
.provider-name {
  @apply font-semibold text-slate-900 mb-3;
}
